export const guides = [
  {
    ...
    body: [
      ...
      "Hardwood, cabinets, and insulation each have their own clock. Carpet and underlay can be lost in the first day. Drywall and insulation start to fail in the 24–48 hour mould window that IICRC S500 describes. Hardwood cups and cabinets swell after that. Insulation that stays wet is usually a tear-out, not a dry-out. Metro Vancouver rooms are cool and damp, so evaporation is slower than the same loss inland — extract the same night and three to five days is still typical; wait, and the log runs longer. The damage-clock bands on this site are that story written for a stressed reader. Use them to see which job you have, not as a countdown.",
